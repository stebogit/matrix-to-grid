 ...
 * //=pt1
 */
var point$3 = function (coordinates, properties) {
    if (!coordinates) throw new Error('No coordinates passed');
    if (coordinates.length === undefined) throw new Error('Coordinates must be an array');
    if (coordinates.length < 2) throw new Error('Coordinates must be at least 2 numbers long');
    if (typeof coordinates[0] !== 'number' || typeof coordinates[1] !== 'number') throw new Error('Coordinates must numbers');
 ...
 * //=linestring2
 */
var lineString$1 = function (coordinates, properties) {
    if (!coordinates) throw new Error('No coordinates passed');
 ...
 * //=fc
 */
var featureCollection$2 = function (features) {
    if (!features) throw new Error('No features passed');
 ...
 *
 */
var multiLineString$1 = function (coordinates, properties) {
    if (!coordinates) throw new Error('No coordinates passed');
 ...
 *
 */
var multiPoint$1 = function (coordinates, properties) {
    if (!coordinates) throw new Error('No coordinates passed');
 ...
 *
 */
var multiPolygon$1 = function (coordinates, properties) {
    if (!coordinates) throw new Error('No coordinates passed');
 ...
 * //=collection
 */
var geometryCollection$1 = function (geometries, properties) {
    if (!geometries) throw new Error('No geometries passed');
 ...
 * @returns {number} distance
 */
var radiansToDistance$1 = function (radians, units) {
 ...
 * @returns {number} degrees
 */
var distanceToDegrees$1 = function (distance, units) {
    var factor = factors$1[units || 'kilometers'];
    if (factor === undefined) throw new Error('Invalid unit');
...
function bbox (bbox) {
  ...
  if (!Array.isArray(bbox)) bbox = index$8(bbox);
...
function center (center) {
  ...
  // Support any GeoJSON
  } else coords = index$12(center).geometry.coordinates;
...
var latitude = index$6.latitude;
var longitude = index$6.longitude;
...
var index = function (matrix, origin, cellSize, options) {
    ...
    var originCoordsMeters = index$4.lngLatToMeters(origin.geometry.coordinates);
    ...
    for (var r = 0; r < matrixRows; r++) {
        ...
        var first = point(index$4.metersToLngLat(firstCoordsMeters));
        ...
        for (var c = 1; c < matrixCols; c++) {
            ...
            var pt = point(index$4.metersToLngLat(pointCoordsMeters));
