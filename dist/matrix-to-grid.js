...
var dms = createCommonjsModule(function (module) {
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
if ('object' != 'undefined' && module.exports) module.exports = Dms; // ≡ export default Dms
});

var latlonSpherical = createCommonjsModule(function (module) {
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
...
'use strict';
if ('object'!='undefined' && module.exports) { var Dms = dms; } // ≡ import Dms from 'dms.js'
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
if ('object' != 'undefined' && module.exports) module.exports = LatLon; // ≡ export default LatLon
});

var vector3d = createCommonjsModule(function (module) {
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
if ('object' != 'undefined' && module.exports) module.exports = Vector3d; // ≡ export default Vector3d
});

var latlonEllipsoidal = createCommonjsModule(function (module) {
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
...
'use strict';
if ('object'!='undefined' && module.exports) { var Vector3d = vector3d; }// ≡ import Vector3d from 'vector3d.js'
if ('object'!='undefined' && module.exports) { var Dms = dms; }           // ≡ import Dms from 'dms.js'
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
if ('object' != 'undefined' && module.exports) module.exports = LatLon, module.exports.Vector3d = Vector3d; // ≡ export { LatLon as default, Vector3d }
});

var latlonVincenty = createCommonjsModule(function (module) {
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
...
'use strict';
if ('object'!='undefined' && module.exports)  // ≡ import LatLon from 'latlon-ellipsoidal.js'
 ...
 */
latlonEllipsoidal.prototype.distanceTo = function(point) {
 ...
 */
latlonEllipsoidal.prototype.initialBearingTo = function(point) {
    if (!(point instanceof latlonEllipsoidal)) throw new TypeError('point is not LatLon object');
 ...
 */
latlonEllipsoidal.prototype.finalBearingTo = function(point) {
    if (!(point instanceof latlonEllipsoidal)) throw new TypeError('point is not LatLon object');
 ...
 */
latlonEllipsoidal.prototype.destinationPoint = function(distance, initialBearing) {
 ...
 */
latlonEllipsoidal.prototype.finalBearingOn = function(distance, initialBearing) {
 ...
 */
latlonEllipsoidal.prototype.direct = function(distance, initialBearing) {
    var φ1 = this.lat.toRadians(), λ1 = this.lon.toRadians();
    ...
    return {
        point:        new latlonEllipsoidal(φ2.toDegrees(), λ2.toDegrees(), this.datum),
 ...
 * @throws  {Error}  If formula failed to converge.
 */
latlonEllipsoidal.prototype.inverse = function(point) {
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
if ('object' != 'undefined' && module.exports) module.exports = latlonEllipsoidal; // ≡ export default LatLon
});

var latlonVectors = createCommonjsModule(function (module) {
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
...
var utm = createCommonjsModule(function (module) {
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
...
'use strict';
if ('object'!='undefined' && module.exports) { var LatLon = latlonEllipsoidal; } // ≡ import LatLon from 'latlon-ellipsoidal.js'
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
if ('object' != 'undefined' && module.exports) module.exports = Utm; // ≡ export default Utm
});

var mgrs = createCommonjsModule(function (module) {
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
...
'use strict';
if ('object'!='undefined' && module.exports)                    // ≡ import Utm from 'utm.js'
if ('object'!='undefined' && module.exports)  // ≡ import LatLon from 'latlon-ellipsoidal.js'
...
function Mgrs(zone, band, e100k, n100k, easting, northing, datum) {
    ...
    if (datum === undefined) datum = latlonEllipsoidal.datum.WGS84; // default if not supplied
...
Mgrs.prototype.toUtm = function() {
    ...
    var nBand = Math.floor(new latlonEllipsoidal(latBand, 0).toUtm().northing/100e3)*100e3;
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
if ('object' != 'undefined' && module.exports) module.exports = Mgrs; // ≡ export default Mgrs
});

var osgridref = createCommonjsModule(function (module) {
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
if ('object' != 'undefined' && module.exports) module.exports = OsGridRef; // ≡ export default OsGridRef
});

var npm = createCommonjsModule(function (module, exports) {
/* npm main module */
'use strict';
exports.LatLonSpherical   = latlonSpherical;
exports.LatLonEllipsoidal = latlonEllipsoidal;
// merge vincenty methods into LatLonEllipsoidal

for (var prop in latlonVincenty) exports.LatLonEllipsoidal[prop] = latlonVincenty[prop];
exports.LatLonVectors     = latlonVectors;
exports.Vector3d          = vector3d;
exports.Utm               = utm;
exports.Mgrs              = mgrs;
exports.OsGridRef         = osgridref;
exports.Dms               = dms;
});

var point = index$2.point;
var featureCollection = index$2.featureCollection;
var GeodesyLatLon = npm.LatLonSpherical;
